...
public class Recipe
{
    ...
    public Recipe(string name, int ingredient1Amount, int ingredient2Amount,  int ingredient3Amount , int ingredient4Amount,  Drop ingredient1, Drop ingredient2,Drop ingredient3,Drop ingredient4, int succesChance, EnhancementType type, int effect)
    {
        this.effect = effect;
        this.type = type;
        this.name = name;
